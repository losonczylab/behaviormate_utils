...
static unsigned char pinS2 = 5;
static unsigned char pinCR = 4;

static unsigned char pinLRIN = 3;
static unsigned char pinLRCLR = 2;
...
const char* position_message = "{\"position\":{\"dy\":%ld, \"dt\":%ld},\
 \"millis\":%lu}";
